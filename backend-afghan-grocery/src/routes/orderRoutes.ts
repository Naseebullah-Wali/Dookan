...
const createOrderValidation = [
    ...
    body('address.recipient_name').if(body('address').exists()).notEmpty().withMessage('Recipient name is required'),
    body('address.phone').if(body('address').exists()).notEmpty().withMessage('Phone is required'),
    body('address.province').if(body('address').exists()).notEmpty().withMessage('Province is required'),
