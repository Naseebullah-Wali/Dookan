<template>
  <div class="not-found-page min-vh-100 d-flex flex-column bg-light">
    <AppHeader />
    
    <div class="container text-center py-5 flex-grow-1 d-flex flex-column justify-content-center">
